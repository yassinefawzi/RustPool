...
fn complex_tests() {
    ...
    assert_eq!(
        vec![
            ...
            1729, 1728, 1653, 1593, 1521, 1459, 1369, 1273, 1197, 1155, 1107, 1084, 1017, 995, 927,
            918, 878, 814, 722, 693, 609, 581, 568, 477, 383, 344, 339, 262, 193, 113, 93, 81, 0
        ],
        parts_sums(&[
            81, 12, 20, 80, 69, 77, 5, 39, 94, 91, 13, 28, 84, 29, 92, 64, 40, 9, 68, 22, 67, 23,
            48, 42, 76, 96, 90, 62, 72, 60, 75, 1, 51, 31, 100, 18, 7, 2, 49, 14, 15, 97, 95, 32,
            93, 4
        ])
    )
}